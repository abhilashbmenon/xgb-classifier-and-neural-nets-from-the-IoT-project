...
from sklearn.metrics import confusion_matrix  # added on 6th sept, 2017
from sklearn.preprocessing import LabelEncoder
from sklearn.preprocessing import OneHotEncoder
from keras.models import Sequential
from keras.layers import Dense
from keras.utils import np_utils  # added on Aug 31, 2017
...
dumy = np_utils.to_categorical(label_encoded_y)
...
for abm in range(70,90):
	...
	for train, test in kfold.split(X, Y):	#CAN I PUT ANY FORM OF Y HERE "dumy" does not work here     # CHANGED ON JULY 14th 
		#create model
		model = Sequential()
		...
		# Fit the model
		history = model.fit(encoded_x[train], dumy[train], nb_epoch=abm, batch_size=256, verbose=0)                    #CHANGED ON JULY 14th
		#history = model.fit(encoded_x, label_encoded_y, validation_split=0.30, nb_epoch=10, batch_size=5)
		#evaluate the model
		scores = model.evaluate(encoded_x[test], dumy[test], verbose=0)
